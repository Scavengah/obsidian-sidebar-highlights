...
This fork builds on **trevware/obsidian-sidebar-highlights** and adds some features tailored to my workflow. It focuses on highlights and comments in the following format: 
...
For some, it might seem like too much code in source mode. But it helps me get what I love about Acrobat into Obsidian—giving me all the great things like the ability to link notes, where in Acrobat they would be kinda stuck in that PDF document. In turn, comment anchors are visible in Reading View, which I missed in Obsidian. I like to keep footnotes as footnotes, and not comments.

There are commands for both adding highlights and adding comment anchors.
...
- Possible to add your own default colors
...
- Automatically scrolls to and flashes the highlight card for easy location
...
> **Note**: This fork was developed with assistance from AI (Claude/GitHub Copilot) for code generation, debugging, and documentation.
